...
This policy governs the handling, licensing, use, and liability of all technical content, software, and research shared within this project, its repository, and associated Discord community.

---

## 1. Licensing of Original Content by the Server Owner

All original technical materials authored by the **Server Owner**—including discoveries, registry tweaks, documentation, guides, and utilities—are licensed under the:
...
3.  **No DRM Circumvention:** We do not condone, host, or permit discussion regarding the bypass of Digital Rights Management (DRM), license checks, or anti-cheat software.
4.  **Educational Intent:** All findings are shared for educational research. Users are responsible for verifying that their use of these tweaks complies with the EULA of the target software.
...
- **No Liability:** The Server Owner and Moderation Team are not responsible for any data leaks resulting from users voluntarily uploading un-sanitized logs or screenshots.
...
- **Proprietary Assets:** Screenshots of private codebases or decompiled output that infringes on copyright.
- **Third-Party Links:** External repositories or hosted media.
...
By applying any tweak or configuration found here, you acknowledge that:
1.  **You assume full risk** for your hardware and software.
2.  **We are NOT liable** for:
    - Hardware damage (overclocking/undervolting risks).
    - Operating System corruption or boot loops.
    - Data loss.
    - Bans/Suspensions from third-party services (e.g., Anti-Cheat bans).
    - Voiding of manufacturer warranties.

**If you do not accept these risks, do not apply the modifications.**
...
- Your misuse of the technical information provided.
- Your infringement of any third-party rights (including EULA breaches).
...
- **Ban Authority:** Access to the community is a privilege, not a right. We reserve the right to remove any user at any time, for any reason, without notice.
